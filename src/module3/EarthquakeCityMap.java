...
//		fill(0,0,0);
		...
		fill(255,0,0);
		ellipse(40, 100,radius*8,radius*8);
		...
		fill(255,255,0);
		ellipse(40, 150,radius*4,radius*4);
		
		fill(0,0,0);
		textSize(11);
		text("4.0 + Magnitude", 55, 153);
		
		fill(0,0,255);
		ellipse(40, 200,radius*2,radius*2);
		
		fill(0,0,0);
		textSize(11);
		text("Below 4.0", 55, 203);
